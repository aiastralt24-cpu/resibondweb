...
export const products: Product[] = [
  {
    ...
    limitations: ["Final technical limits must be confirmed against the official TDS.", "Test colour and substrate compatibility before use."], related: ["weather-5010", "hybrid-2-in-1"]
  },
  {
    ...
    applicationSteps: ["Mask joint edges for a clean finish.", "Gun a continuous bead without air pockets.", "Tool and remove masking before skin formation."], limitations: ["Refer to the official TDS for movement capability and primer requirements."], related: ["neutral-3010", "gp-100"]
  },
  {
  ...
  {
    slug: "zero-nail", name: "Zero Nail", range: "Resibond", chemistry: "SBS", image: "/assets/products/Zero Nail_2026.png",
    ...
    environment: ["Interior"], applications: ["Mounting", "Fixing", "Mirror installation", "Joinery"], substrates: ["Mirror", "Ceramics", "Metal", "Stone", "Wood"], benefits: ["Broad substrate map", "Reduces dependence on visible mechanical fasteners", "Suitable for common mounting jobs"],
  ...
  {
    slug: "buildglaze", name: "BuildGlaze", range: "Resibond NXT", chemistry: "Neutral", image: "/assets/products/BuildGlaze_NXT_2026.png",
    positioning: "Professional glazing route for glass-to-frame joints.", description: "A neutral product associated with glass, glass-to-metal frames and metal applications in the supplied schedule.", environment: ["Interior", "Exterior", "Specialist"], applications: ["Glazing", "Glass-to-metal frames"], substrates: ["Glass", "Metal", "Glass-to-metal frames"], benefits: ["Dedicated glazing positioning", "Neutral chemistry mapping", "Glass-to-metal application route"],
    packSizes: ["Specification pending"], colours: ["Specification pending"], preparation: ["Clean glass and frame surfaces without leaving residue.", "Confirm primer and compatibility requirements from the official TDS."], applicationSteps: ["Apply a continuous bead to the prepared glazing joint.", "Tool to the specified geometry before skin formation."], limitations: ["Structural, movement and facade use cannot be assumed without verified technical documentation."], related: ["neutral-3010", "weather-5010"]
  },
  {
    slug: "bus-seal", name: "Bus Seal", range: "Resibond NXT", chemistry: "Hybrid", image: "/assets/products/Bus Seal_NXT_2026.png",
    positioning: "Specialist sealing route for bus panels and metal assemblies.", description: "A professional hybrid product mapped to bus panels and metal applications in the supplied substrate schedule.", environment: ["Specialist"], applications: ["Bus panels", "Vehicle body sealing"], substrates: ["Bus panels", "Metal"], benefits: ["Vehicle-panel application mapping", "Hybrid chemistry", "Professional specialist range"],
    packSizes: ["Specification pending"], colours: ["Specification pending"], preparation: ["Prepare metal and coated-panel surfaces according to the verified process.", "Test adhesion on production coatings."], applicationSteps: ["Apply to the documented panel joint.", "Tool and allow the specified cure before service or coating."], limitations: ["OEM process compatibility and service limits require official technical approval."], related: ["thermoseal", "hybrid-2-in-1"]
  },
  {
