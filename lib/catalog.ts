...
export const products: Product[] = [
  {
    ...
    environment: ["Interior", "Exterior"], applications: ["Glazing", "Mirrors", "Tinted panels", "ACP joints", "Electrical sealing", "Electronic component sealing"],
    substrates: ["Glass", "Mirror", "Aluminium", "Aluminium roofing", "Metal", "Stone", "UPVC", "Window frames", "Door frames", "Glass-to-metal interfaces", "ACP", "Tinted panels"], benefits: ["Neutral-cure chemistry", "100+ shade options", "Suitable for visible finishing joints"],
    packSizes: ["280 ml", "600 ml"], colours: ["100+ shades"], shelfLife: "12 months from manufacture in unopened packaging", storage: "Store dry in the original closed pack between 2–40°C.", tdsUrl: "/documents/tds/resibond-neutral-3010-tds-july-2026.pdf", sourceUrl: "https://www.astraladhesives.com/resibond-neutral-3010.html", preparation: ["Surfaces must be clean, dry and free from dust, oil and loose material.", "Confirm substrate compatibility before full application."],
  ...
  },
  {
    ...
    substrates: ["ACP", "Façade panels", "Curtain-wall profiles", "Glass", "Aluminium", "Metal", "Stone", "Ceramic", "Plastic", "UPVC", "Window frames", "HVAC ductwork", "Building joints"], benefits: ["Designed for exterior sealing", "Neutral-cure chemistry", "Broad building-envelope relevance"],
    packSizes: ["300 ml"], colours: ["Multiple shades"], shelfLife: "12 months from manufacture in unopened packaging", storage: "Store dry in the original closed cartridge between 2–40°C.", tdsUrl: "/documents/tds/resibond-weather-5010-tds-july-2026.pdf", sourceUrl: "https://www.astraladhesives.com/resibond-weather-5010.html", preparation: ["Ensure joints are dry, sound and contamination-free.", "Use appropriate joint backing where required by the specification."],
  ...
  },
  {
    ...
    environment: ["Interior", "Exterior"], applications: ["Sealing", "Bonding", "Mounting", "Metal fabrication"], substrates: ["ACP", "Mirror", "Metal", "Stone", "Granite", "Concrete", "Wood", "Glass", "UPVC", "Window frames", "Porous surfaces", "Non-porous surfaces"],
    benefits: ["Sealing and bonding in one product", "Permanently elastic and non-shrinking", "Paintable after cure", "Solvent-free and low odour"], packSizes: ["290 ml"], colours: ["Multiple shades"], shelfLife: "12 months from manufacture in unopened packaging", storage: "Store dry in the original closed cartridge between 2–40°C.", tdsUrl: "/documents/tds/resibond-hybrid-2-in-1-tds-july-2026.pdf", sourceUrl: "https://www.astraladhesives.com/resibond-hybrid-2in1-xtra-strength.html",
  ...
  },
  {
    ...
    positioning: "Premium general-purpose acetoxy silicone.", description: "A premium room-temperature curing silicone for interior and exterior sealing on glass, aluminium, metal, wood, porcelain and ceramic.", environment: ["Interior", "Exterior"], applications: ["Glass-to-frame sealing", "Air-conditioner edge gaps", "Window-to-wall joints", "Glass-to-glass joints", "Skirting installation"], substrates: ["Aluminium", "Glass", "Window frames", "Door frames", "Frame-to-wall joints", "AC-to-window edge gaps", "Walls", "Metal", "Wood", "Porcelain", "Ceramic"], benefits: ["Elongation above 350%", "Non-sagging application", "Strong bond and clean finish", "RoHS compliant"], packSizes: ["280 ml"], colours: ["Multiple shades"], shelfLife: "12 months from manufacture in unopened packaging", storage: "Store dry in the original closed cartridge between 2–40°C.", tdsUrl: "/documents/tds/resibond-premium-gp-1010-tds-july-2026.pdf", sourceUrl: "https://www.astraladhesives.com/resibond-premium-gp-1010.html", preparation: ["Ensure the application area is clean and dry."], applicationSteps: ["Apply an even bead to the joint.", "Tool before a surface skin develops."], limitations: ["Confirm sensitive-surface compatibility from the official TDS."], related: ["gp-100", "neutral-3010"]
  },
  {
    slug: "bathmate", name: "Bathmate", range: "Resibond", chemistry: "Acrylic", image: "/assets/products/Bathmate_2026.png",
    positioning: "Flexible acrylic gap filler for bathrooms, kitchens and interior finishing.", description: "A water-based flexible acrylic sealant for gaps around washbasins, kitchen sinks, gypsum boards and electrical boards.", environment: ["Interior"], applications: ["Washbasin-to-wall gaps", "Kitchen sink sealing", "Gypsum board joints", "Electrical board surrounds"], substrates: ["Washbasins", "Kitchen sinks", "Sanitaryware", "Walls", "Gypsum board", "Electrical boards", "Interior construction surfaces"], benefits: ["Anti-fungal and mould resistant", "Forms a watertight seal", "Paintable", "Bright white cured appearance"], packSizes: ["75 g", "300 ml"], colours: ["White"], shelfLife: "18 months from manufacture when stored cool and away from heat", storage: "Store dry in the original closed cartridge between 2–40°C.", tdsUrl: "/documents/tds/resibond-bathmate-tds-july-2026.pdf", sourceUrl: "https://www.astraladhesives.com/resibond-bathmate.html", preparation: ["Remove soap residue, moisture and loose material."], applicationSteps: ["Apply a neat continuous bead and tool immediately.", "Allow at least 24 hours before painting or water exposure."], limitations: ["Protect the fresh seal from water during the first 24 hours."], related: ["doors-windows", "neutral-3010"]
  },
  {
    slug: "doors-windows", name: "Doors & Windows", range: "Resibond", chemistry: "Acrylic", image: "/assets/products/Doors-and-Windows_2026.png",
    positioning: "Paintable acrylic sealant for door, window and masonry gaps.", description: "A permanently flexible water-based acrylic sealant for UPVC frames, sills, masonry joints, electrical boards and cracks in plaster or concrete.", environment: ["Interior", "Exterior"], applications: ["UPVC doors and windows", "Window sills and plinths", "Electrical board surrounds", "Cracks in plaster and concrete"], substrates: ["UPVC", "PVC", "Plastic", "Window frames", "Door frames", "Window sills", "Frame-to-wall joints", "Plinths", "Walls", "Ceramic", "Masonry", "Porous masonry surfaces", "Plaster", "Concrete", "Electrical boards"], benefits: ["Paintable after cure", "Crack bridging", "Anti-fungal", "Water-based"], packSizes: ["300 ml"], colours: ["White"], shelfLife: "18 months from manufacture when stored cool and away from heat", storage: "Store dry in the original closed cartridge between 2–40°C.", tdsUrl: "/documents/tds/resibond-doors-windows-tds-july-2026.pdf", sourceUrl: "https://www.astraladhesives.com/resibond-doors-and-windows.html", preparation: ["Remove dust and loose paint from the gap."], applicationSteps: ["Fill the gap without trapping air.", "Tool flush with adjacent surfaces.", "Allow at least 24 hours before painting or water exposure."], limitations: ["Protect from water until cured."], related: ["bathmate", "gp-100", "premium-gp-1010"]
  },
  {
    slug: "thermoseal", name: "Thermoseal", range: "Resibond", chemistry: "Neutral", image: "/assets/products/Thermoseal_2026.png",
    positioning: "High-temperature neutral silicone for automotive and industrial gasket work.", description: "A heavy-duty neutral-cure silicone for forming and replacing gaskets in engines and other automotive or industrial assemblies.", environment: ["Specialist"], applications: ["Formed-in-place gaskets", "Engines", "Automotive repair", "Industrial assemblies", "Electrical sealing", "Electronic component sealing", "Commercial kitchens"], substrates: ["Metal flanges", "Metal lap joints", "Engine components", "Automotive components", "Electrical assemblies", "Electronic components", "Industrial assemblies", "Commercial kitchens"], benefits: ["Up to 310°C intermittent resistance", "Up to 250°C continuous resistance", "Oil resistant", "Heavy-duty application"], packSizes: ["300 ml"], colours: ["Technical grade"], shelfLife: "12 months from manufacture in unopened packaging", storage: "Store dry in the original closed cartridge between 2–40°C.", tdsUrl: "/documents/tds/resibond-thermoseal-7010-tds-july-2026.pdf", sourceUrl: "https://www.astraladhesives.com/resibond-thermoseal-7010.html", preparation: ["Remove old gasket material, oil and contamination."], applicationSteps: ["Apply a uniform continuous bead around the prepared flange.", "Allow the specified cure before returning the assembly to service."], limitations: ["Temperature resistance is application-dependent; consult the current TDS."], related: ["neutral-3010", "hybrid-2-in-1"]
  },
  {
  ...
  },
  {
    ...
    positioning: "Specialist sealing route for fire doors, fire windows and related joints.", description: "A professional-range product associated with fire-door, fire-window, commercial-kitchen and service-penetration applications in the supplied product map.",
    environment: ["Interior", "Specialist"], applications: ["Fire doors", "Fire windows", "Fire-rated walls and ceilings", "Service penetration sealing", "Commercial kitchens", "Windows"], substrates: ["Fire-rated assemblies", "Fire-rated walls and ceilings", "Electrical cables", "Cable trays", "Conduits", "Pipes", "Fire doors", "Fire windows", "Door frames", "Window frames", "Commercial kitchens"], benefits: ["Application-specific professional range", "Mapped to fire-door and fire-window use cases", "Technical specification required before use"],
    packSizes: ["Specification pending"], colours: ["Specification pending"], tdsUrl: "/documents/tds/resibond-nxt-fireshield-tds-july-2026.pdf", preparation: ["Follow the approved joint design and official technical documentation.", "Confirm substrate, backing material and required fire classification."], applicationSteps: ["Install only within a verified system specification.", "Apply to the documented joint dimensions and tooling requirements."], limitations: ["Do not infer a fire rating from the product name alone.", "System test evidence and the official TDS are required before specification."], related: ["duct-seal", "doors-windows"]
  },
  {
  ...
  },
  {
    ...
    packSizes: ["Specification pending"], colours: ["Specification pending"], tdsUrl: "/documents/tds/resibond-nxt-turf-grass-tds-july-2026.pdf", preparation: ["Ensure the installation surface is stable, clean and appropriately drained.", "Confirm system compatibility with the turf backing."], applicationSteps: ["Apply according to the verified turf-installation method.", "Maintain alignment and pressure during the required initial set."], limitations: ["Coverage, weather and cure requirements must be confirmed from the official TDS."], related: ["hybrid-2-in-1", "zero-nail"]
  },
  {
    ...
    positioning: "Professional sanitary sealing route for wet-area fixtures.", description: "An acetoxy product mapped to shower units, toilets and washbasins in the supplied application schedule.", environment: ["Interior"], applications: ["Shower units", "Toilets", "Washbasins", "Sanitary sealing"], substrates: ["Shower units", "Toilets", "Washbasins", "Sanitaryware", "Sanitary fixtures"], benefits: ["Purpose-led sanitary range", "Acetoxy chemistry mapping", "Mapped to common wet-area fixtures"],
    packSizes: ["Specification pending"], colours: ["Super white"], tdsUrl: "/documents/tds/resibond-nxt-sanitary-super-white-tds-july-2026.pdf", preparation: ["Remove moisture, soap residue and contamination.", "Confirm compatibility with sensitive fixtures and finishes."], applicationSteps: ["Apply a continuous sanitary bead.", "Tool to a smooth profile that avoids water retention."], limitations: ["Acetoxy chemistry may not suit every sensitive substrate.", "Water exposure and cure timing require the official TDS."], related: ["bathmate", "neutral-3010"]
  }
];
