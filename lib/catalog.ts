...
export const products: Product[] = [
  ...
  },
  {
    ...
    substrates: ["Glass", "Aluminium", "Stainless steel", "Galvanized steel", "Concrete", "Masonry", "Brick", "Ceramic tiles", "UPVC", "Polycarbonate", "ACP", "Painted surfaces", "Wood"], benefits: ["Designed for exterior sealing", "Neutral-cure chemistry", "Broad building-envelope relevance"],
