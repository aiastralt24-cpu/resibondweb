...
export const products: Product[] = [
  ...
  },
  {
    ...
    positioning: "Premium general-purpose acetoxy silicone.", description: "A premium room-temperature curing silicone for interior and exterior sealing on glass, aluminium, metal, wood, porcelain and ceramic.", environment: ["Interior", "Exterior"], applications: ["Glass-to-frame sealing", "Air-conditioner edge gaps", "Window-to-wall joints", "Glass-to-glass joints", "Skirting installation"], substrates: ["Aluminium", "Glass", "Window frames", "Door frames", "Frame-to-wall joints", "AC-to-window edge gaps", "Walls", "Metal", "Wood", "Porcelain", "Ceramic"], benefits: ["Elongation above 350%", "Non-sagging application", "Strong bond and clean finish", "RoHS compliant"], packSizes: ["280 ml"], colours: ["Multiple shades"], shelfLife: "12 months from manufacture in unopened packaging", storage: "Store dry in the original closed cartridge between 2–40°C.", tdsUrl: "https://www.astraladhesives.com/media/catalog/product/attachment/r/e/resibond_premium_gp-1010_tds.pdf", sourceUrl: "https://www.astraladhesives.com/resibond-premium-gp-1010.html", preparation: ["Ensure the application area is clean and dry."], applicationSteps: ["Apply an even bead to the joint.", "Tool before a surface skin develops."], limitations: ["Confirm sensitive-surface compatibility from the official TDS."], related: ["gp-100", "neutral-3010"]
  },
  {
