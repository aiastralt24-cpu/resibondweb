export type SelectorApplication = "Bonding" | "Gap filling - interior" | "Gap filling - exterior" | "Specialist sealing";
...
export const selectorCombinations: SelectorCombination[] = [
  ...
  row("Glass", "Back-painted panel", "Bonding", "Mirror Mount", "Zero Nail"),
  row("Coated glass", "Metal panel", "Bonding", "Mirror Mount"),
  row("Wood", "Plaster", "Bonding", "Saves Nails"),
  row("Wood", "Brick", "Bonding", "Saves Nails", "Zero Nail"),
  row("Wood", "Masonry", "Bonding", "Saves Nails", "Zero Nail"),
  row("Metal", "Plaster", "Bonding", "Saves Nails"),
  row("Artificial grass", "Seaming tape", "Bonding", "Turf Grass"),
  ...
  row("Mirror", "Wood", "Bonding", "Mirror Mount", "Neutral 3010", "Zero Nail"),
  row("Mirror", "MDF", "Bonding", "Mirror Mount", "Neutral 3010", "Zero Nail"),
  row("Mirror", "Ceramics", "Bonding", "Mirror Mount", "Neutral 3010", "Zero Nail"),
  row("Mirror", "Metal", "Bonding", "Mirror Mount", "Neutral 3010", "Zero Nail"),
  row("Fire door", "Concrete wall", "Specialist sealing", "FireShield"),
  row("Fire window", "Concrete wall", "Specialist sealing", "FireShield"),
  row("Artificial grass", "Concrete", "Bonding", "Turf Grass"),
  row("Artificial grass", "Wood", "Bonding", "Turf Grass"),
  row("Artificial grass", "Ceramics", "Bonding", "Turf Grass"),
  row("Artificial grass", "Metal", "Bonding", "Turf Grass"),
  row("Metal duct", "Metal duct", "Specialist sealing", "Duct Seal"),
  row("Fibre-glass duct", "Fibre-glass duct", "Specialist sealing", "Duct Seal"),
  row("Kitchen sink", "Countertop", "Gap filling - interior", "Kitchen & Sink", "Sanitary Super White"),
  row("Wash basin", "Wall", "Gap filling - interior", "Bathmate", "Sanitary Super White"),
  row("Bathtub", "Wall", "Gap filling - interior", "Sanitary Super White"),
  row("Commode", "Tile", "Gap filling - interior", "Sanitary Super White"),
  row("Electrical switch board", "Wall", "Gap filling - interior", "Bathmate"),
  row("Galvanized steel duct", "Galvanized steel duct", "Specialist sealing", "Duct Seal"),
  row("Aluminium duct", "Aluminium duct", "Specialist sealing", "Duct Seal"),
  row("Mild steel duct", "Mild steel duct", "Specialist sealing", "Duct Seal"),
  row("Electrical cable", "Concrete wall", "Specialist sealing", "FireShield"),
  row("Fire-retardant pipe", "Concrete", "Specialist sealing", "FireShield"),
  row("Fire-rated door", "Frame", "Specialist sealing", "FireShield"),
  row("Engine flange", "Engine flange", "Specialist sealing", "Thermoseal"),
  row("Heating element", "Appliance", "Specialist sealing", "Thermoseal"),
];
