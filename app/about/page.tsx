...
export default function Page(){return <>
  ...
  <section className="about-astral" id="astral-adhesives" aria-labelledby="about-astral-title">
    <div className="about-astral-heading"><div className="astral-adhesives-lockup"><Image className="astral-adhesives-mark" src="/assets/logos/astral-adhesives-logo.png" alt="Astral Adhesives" width={4167} height={1671}/><span className="section-index">Backed by Astral Adhesives</span></div><h2 id="about-astral-title">Bonding innovation with quality.</h2></div>
