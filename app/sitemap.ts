...
import { applications, chemistries, products, slugify, substrates } from "@/lib/catalog";
import { solutions } from "@/lib/solutions";

export default function sitemap(): MetadataRoute.Sitemap {
  const base = process.env.NEXT_PUBLIC_SITE_URL || "http://localhost:3000";
  const staticRoutes = ["", "/products", "/solutions", "/chemistries", "/applications", "/substrates", "/product-finder", "/technical-data-sheets", "/about", "/privacy", "/contact"];
  return [
